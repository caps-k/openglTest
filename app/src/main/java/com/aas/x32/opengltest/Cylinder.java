...
public class Cylinder
{
    ...
    private float _hight = 3.0f;

    private FloatBuffer _planeBuffer;

    public Cylinder(float radius, float hight, int row, int col)
    {
        this._radius = radius;
        this._hight = hight;
        this._col = col;
    ...
    private void createGraphics()
    {
        ...
        for(int i = 0; i < this._row; i++)
        {
            ...
            float tmpHight = this._hight * -0.5f + i * (this._hight/(this._row-1));
    ...
    public void draw(GL10 gl)
    {
        ...
        gl.glDrawArrays(GL10.GL_TRIANGLES, 0, (this._col-1)*(this._row-1)*2*3);
